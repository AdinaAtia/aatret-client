...
// import { 
//   Box, Typography, Table, TableBody, TableCell, TableContainer, Button,
...
//     width: 280, 
//     height: '100vh', 
//     bgcolor: COLORS.BLACK, // רקע שחור יוקרתי
//     color: '#fff',
...
//     top: 0
//   }}>
//     <Typography variant="h6" sx={{ mb: 4, fontWeight: 800, color: COLORS.BROWN_LIGHT }}>
//       תפריט מנהל
//     </Typography>
...
//             color: '#fff', 
//             '&:hover': { bgcolor: 'rgba(255,255,255,0.1)', color: COLORS.BROWN_LIGHT } 
//           }}
//         >
//           {text}
//         </Button>
...
// const ManageLessons = () => {
//   return (
//     <Box sx={{ display: 'flex', direction: 'rtl', bgcolor: '#fdfdfd' }}>
   
//    <Sidebar></Sidebar>
   
   
//     <Box sx={{ p: { xs: 2, md: 4 }, bgcolor: '#fdfdfd', minHeight: '100vh', direction: 'rtl' }}>
      
//       {/* כותרת עליונה */}
//       <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 4 }}>
//         <Box>
//           <Typography variant="h4" sx={{ fontWeight: 900, color: COLORS.BLACK, mb: 0.5 }}>
//             ניהול שיעורים
//           </Typography>
//           <Typography variant="body2" sx={{ color: COLORS.TEXT_GRAY }}>
//             עדכון נתוני אודיו, PDF וצפייה בסטטיסטיקות
//           </Typography>
//         </Box>
//         <Chip 
//           icon={<PlayCircleOutlineIcon style={{ color: '#fff' }} />} 
//           label="סנכרון יוטיוב פעיל" 
//           sx={{ bgcolor: COLORS.BROWN_DARK, color: '#fff', fontWeight: 700, px: 1 }} 
//         />
//       </Stack>

//       {/* שורת חיפוש מעוצבת */}
//       <Paper elevation={0} sx={{ 
//         p: 2, mb: 3, borderRadius: '16px', border: '1px solid #ececec',
//         bgcolor: COLORS.BG_CREAM 
//       }}>
//         <TextField 
//           fullWidth
//           placeholder="חפשי לפי כותרת, רב או קטגוריה..."
//           InputProps={{
//             startAdornment: (
...
//           <TableHead>
//             <TableRow>
//               <TableCell sx={{ bgcolor: COLORS.BLACK, color: '#fff', fontWeight: 700, py: 2 }}>שיעור</TableCell>
//               <TableCell sx={{ bgcolor: COLORS.BLACK, color: '#fff', fontWeight: 700 }}>תיקיית שמע (AudioDir)</TableCell>
//               <TableCell sx={{ bgcolor: COLORS.BLACK, color: '#fff', fontWeight: 700 }}>שם קובץ (AudioFileName)</TableCell>
//               <TableCell sx={{ bgcolor: COLORS.BLACK, color: '#fff', fontWeight: 700, textAlign: 'center' }}>צפיות</TableCell>
//               <TableCell sx={{ bgcolor: COLORS.BLACK, color: '#fff', fontWeight: 700, textAlign: 'center' }}>פעולות</TableCell>
//             </TableRow>
//           </TableHead>
//           <TableBody>
//             {[1, 2, 3].map((item) => (
//               <TableRow key={item} hover sx={{ '&:nth-of-type(even)': { bgcolor: '#fafafa' } }}>
//                 <TableCell>
//                   <Typography sx={{ fontWeight: 700, fontSize: '0.95rem' }}>שיעור {30 + item} - כוונות התפילה</Typography>
//                   <Typography variant="caption" sx={{ color: COLORS.BROWN_LIGHT, fontWeight: 600 }}>קטגוריה: תפילה תשפ"ה</Typography>
//                 </TableCell>
//                 <TableCell>
//                   <TextField 
//                     size="small" 
//                     variant="outlined" 
//                     defaultValue="/JH/BVG Folder"
...
//                     size="small" 
//                     variant="outlined" 
//                     defaultValue="lesson-audio.mp3"
//                     sx={{ '& .MuiOutlinedInput-root': { borderRadius: '8px', fontSize: '0.85rem' } }}
//                   />
//                 </TableCell>
//                 <TableCell align="center">
//                   <Typography sx={{ fontWeight: 800, color: COLORS.BROWN_DARK }}>274</Typography>
//                 </TableCell>
//                 <TableCell align="center">
...
//                         '&:hover': { bgcolor: COLORS.BROWN_DARK, color: '#fff' }
//                       }}>
//                         <SaveIcon fontSize="small" />
//                       </IconButton>
//                     </Tooltip>
//                     <IconButton sx={{ color: COLORS.TEXT_GRAY }}>
