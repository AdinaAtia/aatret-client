...
//     navigate('/admin')
//       // כאן תבוא הפקודה למעבר עמוד, לדוגמה: navigate('/dashboard');
...
//       setLoading(false);
//     }
//   }; // <--- כאן הפונקציה נסגרת בצורה נכונה
...
//           </Typography>
// {/* הצגת הודעת שגיאה באותיות קטנות ואדומות */}
// {error && (
//   <Typography 
//     variant="caption" 
//     sx={{ 
//       color: '#d32f2f', // צבע אדום של MUI
//       display: 'block', 
//       textAlign: 'right', // הצמדה לימין כי האתר בעברית
//       mt: -2, // מרווח שלילי כדי שזה יהיה קרוב לשורה שמעל
//       mb: 2,  // מרווח מלמטה כדי שלא יידבק לשדות
//       fontWeight: '500' 
//     }}
//   >
//     * {error}
